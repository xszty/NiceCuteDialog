...
public class AESCoder {
    ...
    public static String encrypt(String data, String IV) throws Exception {
        Key key = AESCoder.toKey("SHML2ECHINACOALK".getBytes());
        return new String(android.util.Base64.encode(encrypt(data.getBytes("utf-8"), key, DEFAULT_CIPHER_ALGORITHM, IV), android.util.Base64.NO_WRAP));
    }
}